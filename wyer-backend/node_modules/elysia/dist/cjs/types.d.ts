...
export type MacroToContext<in out MacroFn extends Macro = {}, in out SelectedMacro extends BaseMacro = {}, in out Definitions extends DefinitionBase['typebox'] = {}, in out R extends 1[] = [1]> = Prettify<{} extends SelectedMacro ? {} : R['length'] extends 16 ? {} : UnionToIntersect<{
    [key in keyof SelectedMacro]: ReturnTypeIfPossible<MacroFn[key], SelectedMacro[key]> extends infer Value ? {
        resolve: true extends SelectedMacro[key] ? ExtractResolveFromMacro<Extract<Exclude<FunctionArrayReturnType<Value['resolve']>, AnyElysiaCustomStatusResponse>, Record<any, unknown>>> : {};
...
type InlineResponse = string | number | boolean | Record<any, unknown> | Response | AnyElysiaCustomStatusResponse | ElysiaFile | Record<any, unknown>;
export type InlineHandler<Route extends RouteSchema = {}, Singleton extends SingletonBase = {
    ...
    200: any;
} ? Route['response'][200] : unknown) | Route['response'][keyof Route['response']] | InlineHandlerResponse<Route['response'] & MacroContext['response']>>);
...
export type GuardLocalHook<Input extends BaseMacro | undefined, Schema extends RouteSchema, Singleton extends SingletonBase, Parser extends keyof any, GuardType extends GuardSchemaType, AsType extends LifeCycleType, BeforeHandle extends MaybeArray<OptionalHandler<Schema, Singleton>>, AfterHandle extends MaybeArray<AfterHandler<Schema, Singleton>>, ErrorHandle extends MaybeArray<ErrorHandler<any, Schema, Singleton>>> = (Input extends any ? Input : Prettify<Input>) & {
    /**
     * @default 'override'
     */
    as?: AsType;
...
export type ExcludeElysiaResponse<T> = PartialIf<Exclude<Awaited<T>, AnyElysiaCustomStatusResponse> extends infer A ? IsNever<A> extends true ? {} : UnionToIntersect<A & {}> : {}, undefined extends Awaited<T> ? true : false>;
